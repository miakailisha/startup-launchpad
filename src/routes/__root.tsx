...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Handy Hands — Trusted help for home, tech and grooming" },
      { name: "description", content: "Handy Hands is a small local team helping with tech setup, house jobs, home-visit barbing and everyday goods." },
      { name: "author", content: "Handy Hands" },
      { property: "og:title", content: "Handy Hands — Trusted local help" },
      { property: "og:description", content: "One friendly team for tech help, home tasks, barbing at home and everyday essentials." },
